...
export const Portfolio = () => {
  const portfolioCategories = [
    ...
    {
      title: "Branding",
      description: "Complete brand identity systems that tell your unique story effectively.",
    ...
    {
      title: "Logo Designs",
      description: "Memorable logos that represent your brand and stand out in the marketplace.",
    ...
    {
      title: "Video Edits",
      description: "Professional video editing for all platforms, creating compelling narratives.",
    ...
    },
    {
      ...
      description: "Engaging short-form content that converts viewers into customers effectively.",
    ...
    {
      title: "Podcast Edits",
      description: "Clean, professional podcast editing that enhances audio quality seamlessly.",
    ...
    },
    {
      ...
      description: "Dynamic animations that bring your ideas to life with stunning visual effects.",
            ...
            return (
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <p className="font-body text-gray-400 mb-6 text-sm leading-relaxed min-h-[3rem]">
